...
//-----------------------------------------------------------------------------
	...
	public:
		...
		void					CheckColisions(ULONG limitX, ULONG limitY);
		void                    rotate(const char* szImageFile, double degree);
		...
		//void					rotate(float t);
		std::vector<CBullet*>* Bullets() { return &m_pBullet; }
	private:
		//-------------------------------------------------------------------------
